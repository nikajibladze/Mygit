...
! function(e) {
    ...
    t.prototype.openLeftBar = function() {
        ...
        e("#wrapper").hasClass("enlarged") || (e(this).parent().hasClass("has_sub") && t.preventDefault(), e(this).hasClass("subdrop") ? e(this).hasClass("subdrop") && (e(this).removeClass("subdrop"), e(this).next("ul").slideUp(350), e(".float-right i", e(this).parent()).removeClass("mdi-minus").addClass("mdi-plus")) : (e("ul", e(this).parents("ul:first")).slideUp(350), e("a", e(this).parents("ul:first")).removeClass("subdrop"), e("#sidebar-menu .float-right i").removeClass("mdi-minus").addClass("mdi-plus"), e(this).next("ul").slideDown(350), e(this).addClass("subdrop"), e(".float-right i", e(this).parents(".has_sub:last")).removeClass("mdi-plus").addClass("mdi-minus"), e(".float-right i", e(this).siblings("ul")).removeClass("mdi-minus").addClass("mdi-plus")))
...
function(e) {
    ...
    t.prototype.launchFullscreen = function(e) {
        ...
        (document.fullscreenEnabled || document.mozFullScreenEnabled || document.webkitFullscreenEnabled) && (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement ? this.exitFullscreen() : this.launchFullscreen(document.documentElement))
    }, t.prototype.init = function() {
        var e = this;
...
function(e) {
    ...
    t.prototype.initTooltipPlugin = function() {
        ...
        }), e(window).resize(debounce(resizeitems, 100)), e("body").trigger("resize")
    }, t.prototype.init = function() {
    ...
    }, e.AppziaApp = new t, e.AppziaApp.Constructor = t
}(window.jQuery),
function(e) {
    "use strict";
    window.jQuery.AppziaApp.init()
}();
var w, h, dw, dh, toggle_fullscreen = function() {};
